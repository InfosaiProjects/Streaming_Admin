...
<body>
					...
					<form>
							...
							<div class="col-sm-10">
								<select class="form-control" id="agencyId">
									<%
										...
										while (rs.next()) {
									%>
									<option value="<%=rs.getObject(1) + "/" + rs.getObject(10)%>"><%=rs.getObject(4)%></option>
									<%
										}
									%>
								</select>
						...
						<div class="form-group row">
							<label for="staticEmail" class="col-sm-2 col-form-label">Agency
								Code</label>
							<div class="col-sm-10">
								<label for="agencyCode" class="col-sm-2" id="agencyCode">
								</label>
							</div>
						</div>
						...
						<div class="form-group row">
							<label for="staticEmail" class="col-sm-2 col-form-label">Total
								Coins</label>
							<div class="col-sm-10">
								<label for="agencyCode" class="col-sm-2" id="agencyTotalCoins">
								</label>
							</div>
						</div>
	...
	<script>
		...
		agencyId.onchange = function() {
			...
			var value2 = agencyId.split("/")[1];
			agencyCode.innerHTML = value1;
			agencyTotalCoins.innerHTML = value2;
		}

		function insertFunction() {
			var agencyCode = document.getElementById("agencyCode").innerHTML;
			var showRange = document.getElementById("showRange").value;
			var task = "transferToAgency";
