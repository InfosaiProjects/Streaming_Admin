...
<body>
	...
	ArrayList<String> alMemberInfo;
	ProfileDao dao = new ProfileDao();
	alMemberInfo = dao.getMemberInfo(memberId);
	%>

	<div class="container">
		<div class="main-body">
<marquee class="text-danger">!!!!!!!!!!!!!!!!! Working in progress !!!!!!!!!!!!!!!!!</marquee>
			<!-- Breadcrumb -->
					...
					<div class="card mb-3">
						<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-sm-6 text-secondary text-danger"></div>
							</div>
						</div>
					</div>
